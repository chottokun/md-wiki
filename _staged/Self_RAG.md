...
[5 https://github.com/princeton-nlp/ALCE](https://github.com/princeton-nlp/ALCE)
...
| A   | SELF-RAG Details     | SELF-RAG Details               |   17 |
|-----|----------------------|--------------------------------|------|
...
| Algorithm 2 SELF-RAG Training   | Algorithm 2 SELF-RAG Training                                              |                                                                            |
|---------------------------------|----------------------------------------------------------------------------|----------------------------------------------------------------------------|
| 1: 2: 3: 4: 5: 6:               | Input input-output data D = { X,Y } , generator M , C θ                    | Input input-output data D = { X,Y } , generator M , C θ                    |
|                                 | Initialize C with a pre-trained LM                                         | Initialize C with a pre-trained LM                                         |
|                                 | Sample data { X sample ,Y sample } ∼ { X,Y                                 | ▷ Training Critic LM(Section 3.2.1)                                        |
|                                 | for ( x, y ) ∈ ( X sample ,Y sample ) do ▷ Data collections for C          | for ( x, y ) ∈ ( X sample ,Y sample ) do ▷ Data collections for C          |
|                                 | Prompt GPT-4 to collect a reflection token r for ( x, y )                  | Prompt GPT-4 to collect a reflection token r for ( x, y )                  |
|                                 | Add { ( x, y, r ) } to D critic                                            | Add { ( x, y, r ) } to D critic                                            |
| 7:                              | Update C with next token prediction loss ▷ Critic learning; Eq. 1          | Update C with next token prediction loss ▷ Critic learning; Eq. 1          |
| 8:                              | Initialize M with a pre-trained LM ▷ Training Generator LM(Section 3.2.2)  | Initialize M with a pre-trained LM ▷ Training Generator LM(Section 3.2.2)  |
| 9: 10:                          | for ( x, y ) ∈ ( X,Y ) do critic Run C to predict r given ( x, y )         | ▷ Data collection for M with D                                             |
| 11:                             | Add ( x, y, r ) to D gen                                                   | Add ( x, y, r ) to D gen                                                   |
| 12:                             |                                                                            |                                                                            |
|                                 | Update M on D with next token prediction loss ▷ Generator LM learning; Eq. | Update M on D with next token prediction loss ▷ Generator LM learning; Eq. |
|                                 | gen                                                                        | gen                                                                        |
| 2                               | 2                                                                          | 2                                                                          |
